...
public class Game {
	...
	public Game (WorkingGame g) {
	    this.id = g.id;
	    this.aa = g.boardstate[0][0].getValue();
	    this.ab = g.boardstate[0][1].getValue();
	    this.ac = g.boardstate[0][2].getValue();
	    this.ad = g.boardstate[0][3].getValue();
	    this.ae = g.boardstate[0][4].getValue();
	    this.af = g.boardstate[0][5].getValue();
	    this.ag = g.boardstate[0][6].getValue();
	    this.ah = g.boardstate[0][7].getValue();
	    this.ba = g.boardstate[1][0].getValue();
	    this.bb = g.boardstate[1][1].getValue();
	    this.bc = g.boardstate[1][2].getValue();
	    this.bd = g.boardstate[1][3].getValue();
	    this.be = g.boardstate[1][4].getValue();
	    this.bf = g.boardstate[1][5].getValue();
	    this.bg = g.boardstate[1][6].getValue();
	    this.bh = g.boardstate[1][7].getValue();
	    this.ca = g.boardstate[2][0].getValue();
	    this.cb = g.boardstate[2][1].getValue();
	    this.cc = g.boardstate[2][2].getValue();
	    this.cd = g.boardstate[2][3].getValue();
	    this.ce = g.boardstate[2][4].getValue();
	    this.cf = g.boardstate[2][5].getValue();
	    this.cg = g.boardstate[2][6].getValue();
	    this.ch = g.boardstate[2][7].getValue();
	    this.da = g.boardstate[3][0].getValue();
	    this.db = g.boardstate[3][1].getValue();
	    this.dc = g.boardstate[3][2].getValue();
	    this.dd = g.boardstate[3][3].getValue();
	    this.de = g.boardstate[3][4].getValue();
	    this.df = g.boardstate[3][5].getValue();
	    this.dg = g.boardstate[3][6].getValue();
	    this.dh = g.boardstate[3][7].getValue();
	    this.ea = g.boardstate[4][0].getValue();
	    this.eb = g.boardstate[4][1].getValue();
	    this.ec = g.boardstate[4][2].getValue();
	    this.ed = g.boardstate[4][3].getValue();
	    this.ee = g.boardstate[4][4].getValue();
	    this.ef = g.boardstate[4][5].getValue();
	    this.eg = g.boardstate[4][6].getValue();
	    this.eh = g.boardstate[4][7].getValue();
	    this.fa = g.boardstate[5][0].getValue();
	    this.fb = g.boardstate[5][1].getValue();
	    this.fc = g.boardstate[5][2].getValue();
	    this.fd = g.boardstate[5][3].getValue();
	    this.fe = g.boardstate[5][4].getValue();
	    this.ff = g.boardstate[5][5].getValue();
	    this.fg = g.boardstate[5][6].getValue();
	    this.fh = g.boardstate[5][7].getValue();
	    this.ga = g.boardstate[6][0].getValue();
	    this.gb = g.boardstate[6][1].getValue();
	    this.gc = g.boardstate[6][2].getValue();
	    this.gd = g.boardstate[6][3].getValue();
	    this.ge = g.boardstate[6][4].getValue();
	    this.gf = g.boardstate[6][5].getValue();
	    this.gg = g.boardstate[6][6].getValue();
	    this.gh = g.boardstate[6][7].getValue();
	    this.ha = g.boardstate[7][0].getValue();
	    this.hb = g.boardstate[7][1].getValue();
	    this.hc = g.boardstate[7][2].getValue();
	    this.hd = g.boardstate[7][3].getValue();
	    this.he = g.boardstate[7][4].getValue();
	    this.hf = g.boardstate[7][5].getValue();
	    this.hg = g.boardstate[7][6].getValue();
	    this.hh = g.boardstate[7][7].getValue();
